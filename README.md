...
3. If Windows asks permission to run the program, click **Yes**.
4. The setup wizard appears. Follow the on-screen instructions.
5. Choose the installation folder or leave it at the default setting.
6. Click **Install** to begin.
7. Wait a moment while Genesis installs.
